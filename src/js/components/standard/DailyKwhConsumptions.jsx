...
import DailyKwhConsumptionsGraph from "./DailyKwhConsumptionsGraph.jsx";


const DailyKwhConsumptions = (props) => {
  ...
  const getAllData = (dta) => {
    ...
    for (var i = 0; i < AllDevices.length; i++) {
      ...
      if (projectId === "ktrLX") {
        ...
        if (
          deviceName != "To Servo Stabilizer" &&
          deviceName != "Incomer" &&
          deviceName != "INCOMER"
        ) {
          const projectId = device.projectId;
        ...
        if (deviceName != "Incomer" && deviceName != "INCOMER") {
          const projectId = device.projectId;
    ...
    <>
      {dataFormat === "table" && (
        <div className="kwhCont">
          <div className="kwhsm">
            <h4>Top 5 Daily Kwh Consumptions </h4>
      ...
      {dataFormat === "graph" && (
        <DailyKwhConsumptionsGraph kwhData={kwhData} />
      )}
...
export default DailyKwhConsumptions ;